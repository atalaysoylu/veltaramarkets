...
export const tr = {
  ...
  deposit: {
    ...
    pickBankTitle: 'Bankanızı Seçin',
    pickBankSub: 'Hangi bankadan göndereceksiniz?',
    searchPlaceholder: 'Banka ara…',
    continue: 'Devam Et',
    errPickBank: 'Lütfen bir banka seçin.',
    errAmount: 'Geçerli bir tutar girin.',
    amountTitle: 'Tutar',
    amountSub: 'Yatırmak istediğiniz tutarı girin',
  ...
  paymentPage: {
    metaTitle: 'Veltara Markets — Ödeme Bilgileri',
    title: 'Ödeme Bilgileri',
    intro: 'Aşağıdaki bilgiler örnek amaçlıdır.',
...
export const en = {
  ...
  deposit: {
    ...
    pickBankTitle: 'Choose your bank',
    pickBankSub: 'Which bank will you transfer from?',
    searchPlaceholder: 'Search bank…',
    continue: 'Continue',
    errPickBank: 'Please select a bank.',
    errAmount: 'Enter a valid amount.',
    amountTitle: 'Amount',
    amountSub: 'Enter the amount you want to deposit',
  ...
  paymentPage: {
    metaTitle: 'Veltara Markets — Payment Details',
    title: 'Payment Details',
    intro: 'The information below is for example purposes.',
    ibanTitle: 'Bank (IBAN)',
